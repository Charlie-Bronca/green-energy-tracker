...
const Home = () => {
  ...
  return (
    <>
      ...
      <main class="main-section" id="main-section-scroll">
      ...
      <section class="uk-energy-tracker" id="uk-energy-tracker-scroll">
          ...
          <div class="energy-generation">
            ...
            <div class="generation-text">
              <img
                ...
                class="energy-icon"
              />
              <h2 class="h2-energy-generation">
                Monthly Energy Generation Statistics
              </h2>
              <h3 class="h3-energy-generation">
                New low carbon records in April
              </h3>
              <p class="paragraph-energy-generation">
                In April, wind was our largest source of generation for the
                third consecutive month, providing 35.1% of our electricity.
              </p>
              <p class="paragraph-energy-generation">
                59% of electricity came from zero-carbon sources, peaking at 88%
                on 15 April at 1pm.
              </p>
              <p class="paragraph-energy-generation">
                During April, Great Britain achieved two new low carbon records.
                On 5 April the low carbon record was broken for the first time
                at 21gCO2/kWh, beating the previous record of 27gCO2/kWh. Ten
                days later, on 15 April at 1pm, the record was broken again at
                19gCO2/kWh.
              </p>
              <p class="paragraph-energy-generation">
                On 15 April the share of Great Britain’s electricity being
                generated by fossil fuels also fell to a record low of 2.4%.
              </p>
            </div>
          </div>
